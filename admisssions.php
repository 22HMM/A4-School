<?php include_once('layouts/header.php'); ?>
    ...
    <div class="row g-0">
        ...
        <div class="container">
            <div class="row">
                <h2 class=" text-uppercase my-3 fw-bold text-center content-heading heading"
                    style="color: var(--primary-color); font-family: var(--main-font);">Admissions
                    Inquiries</h2>
                <p class="my-2 content-para"
                    style="font-family: var(--secondary-font);font-size: 16px; color: var(--primary-text);">
                            ...
                            <div class="col-md-6">
                                <div class="my-3">
                                    ...
                                    <input type="text" class="form-control border-0 py-3 my-2" name="name"
                                        ...
                                        style="color: #808080;  background-color: #FCFAF8; font-size: 15px">
                                </div>
                                <div class="my-3">
                        ...
                        <div class="row">
                            <div class="my-3">
                                ...
                                <textarea name="message" id="" cols="30" rows="8"
                                    ...
                                    style="color: #808080;  background-color: #FCFAF8; font-size: 15px;">Write Comments</textarea>
                            </div>
                        </div>
                        <div class="row my-3">
                            <div>
                                <a href="" class="btn w-100 rounded-3 py-3 text-white text-center"
                                    style="background-color: var(--secondary-color);">Send Message</a>
                            </div>
                        </div>
                    </form>
                </div>
